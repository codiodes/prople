...
import com.codiodes.prople.Fragments.HomeFragment;


public class MainUserPage extends ActionBarActivity
    ...
    public void onSectionAttached(int number) {
        switch (number) {
            ...
            case 2:
                ...
                break;
            case 3:
                mTitle = getString(R.string.terms_and_conditions);
                break;
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        if (!mNavigationDrawerFragment.isDrawerOpen()) {
            ...
            getMenuInflater().inflate(R.menu.main_user_page, menu);
            restoreActionBar();
            return true;
        }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public void onAttach(Activity activity) {
            ...
            ((MainUserPage) activity).onSectionAttached(
